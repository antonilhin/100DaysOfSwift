...
class ViewController: UIViewController {
            ...
            context.evaluatePolicy(.deviceOwnerAuthenticationWithBiometrics, localizedReason: reason) {
                ...
                DispatchQueue.main.async {
                    if success {
                        ...
                        ac.addAction(UIAlertAction(title: "Password", style: .default, handler: self?.password))
    ...
    func createPassword() {
        let ac = UIAlertController(title: "Create new password", message: nil, preferredStyle: .alert)
