...
class ViewController: UICollectionViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate, MCSessionDelegate, MCBrowserViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let showDevices = UIBarButtonItem(title: "Devices", style: .plain, target: self, action: #selector(showClients))
        let sendMessage = UIBarButtonItem(title: "Chat", style: .plain, target: self, action: #selector(sendMessageAction))
        
        toolbarItems = [showDevices, spacer, sendMessage]
