...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    var windSpeed = 0 {
        didSet {
            if windSpeed > 0 {
                ...
                windLabel.text = "Wind: <-- \(abs(windSpeed)) m/s  "
            } else {
    ...
    override func didMove(to view: SKView) {
        ...
        windLabel.position = CGPoint(x: 512, y: 660)
        windLabel.zPosition = 2
        addChild(windLabel)
        
        if viewController != nil {
            player1ScoreLabel.text = "Score P1: \(viewController.player1Score)"
            player2ScoreLabel.text = "Score P2: \(viewController.player2Score)"
        }
        
        wonPlayerLabel = SKLabelNode(fontNamed: "Helvetica")
