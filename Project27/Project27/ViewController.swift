...
class ViewController: UIViewController {
    ...
    func drawEmoji() {
        ...
        let image = renderer.image { ctx in
            ...
            let face = CGRect(x: 0, y: 0, width: 500, height: 500).insetBy(dx: 5, dy: 5)
            ...
            let leftEye = CGRect(x: 100, y: 160, width: 50, height: 70)
            ctx.cgContext.setFillColor(UIColor.black.cgColor)
            ctx.cgContext.setStrokeColor(UIColor.black.cgColor)
            ctx.cgContext.addEllipse(in: leftEye)
            ctx.cgContext.drawPath(using: .fillStroke)
            
            let rightEye = CGRect(x: 355, y: 160, width: 50, height: 70)
            ctx.cgContext.setFillColor(UIColor.black.cgColor)
            ctx.cgContext.setStrokeColor(UIColor.black.cgColor)
            ctx.cgContext.addEllipse(in: rightEye)
            ctx.cgContext.drawPath(using: .fillStroke)
            
            let mouth = CGRect(x: 190, y: 280, width: 140, height: 180)
            ctx.cgContext.setFillColor(UIColor.black.cgColor)
